...
typealias ParameterRequest = (_ parameterRequest: HKParameterRequest) -> Void;
typealias BodyRequest = (_ entityRequest: HKBodyRequest) -> Void;
...
class HKRest {
    ...
    {
        let _config = getConfig(instance: HKParameterRequest(), config:config);
    ...
    {
        let _config = getConfig(instance: HKBodyRequest(), config:config);
